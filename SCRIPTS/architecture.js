...
function getArticle () {
    fetch(`https://infobtp-website-indol.vercel.app/architecture`)
    ...
    .then(data => {
            ...
            <div class="trending-top mb-30 article-item" data-article-id="${element._id}">
                <div class="trend-top-img">
                    ...
                    <div class="trend-top-cap">
                        ...
                        <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">Pubilié Par  ${element.auteur}   -   ${ convertionDate(element.datePublication)}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class=" whats-news-single mb-40 mb-40 article-item" data-article-id="${element._id}">
            ...
            <div class="whates-caption whates-caption2">
                ...
                <span>Publié par ${element.auteur}   -   ${convertionDate(element.datePublication)} </span>
        ...
        articleItem.forEach(item => {
            item.addEventListener('click', () => {
                ...
                window.location.href = `article_architectures.html?id=${articleId}`;
            })
