...
function getArticle () {
    fetch(`https://infobtp-website-indol.vercel.app/produitsMateriaux`)
    ...
    .then(data => {
            ...
            <div class="trending-top mb-30 article-item" data-article-id="${element._id}">
                <div class="trend-top-img">
                    ...
                    <div class="trend-top-cap">
                        ...
                        <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">Publié par ${element.auteur} - ${convertionDate(element.datePublication)}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        articleItem.forEach(item => {
            item.addEventListener('click', () => {
                ...
                window.location.href = `article_produitsmateriaux.html?id=${articleId}`;
            })
